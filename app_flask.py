...
@app.route('/')
def index():
    # Create an HTML page with an iframe to the Gradio interface
    html = """
    <!DOCTYPE html>
    <html>
    <head>
        <title>AnimeGANv2 Portrait Converter</title>
        <style>
            body {
    ...
    <body>
        <div class="container">
            <h1>AnimeGANv2 Portrait Converter</h1>
            <div class="description">
                <p>Convert your portrait photos into anime-style images using advanced machine learning models.</p>
            </div>
...
def gradio_interface():
    # Gradio app will be embedded in the iframe from index page
    return gr.Blocks.get_template_html(
        demo,
        title="AnimeGANv2 Portrait Converter",
        favicon=None
    )
